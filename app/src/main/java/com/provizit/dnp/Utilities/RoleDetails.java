...
public class RoleDetails implements Serializable {
    private String  r_id,name,desc,location,hierarchy,approver,meeting,reports,smeeting,visitors,dvisitors,operations,rmeeting,uvisitors,bydefault,checkin,aworkflow,security;

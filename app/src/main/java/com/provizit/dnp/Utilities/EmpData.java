...
public class EmpData implements Serializable {
    ...
    private String name,designation,branch,department,email,mobile,mobilecode,roleid,rolename,location,hierarchy_indexid,hierarchy_id,approver,emp_id,emp_image1;
